(module
  ...
  (data (i32.const 0) "print$a0sqrtxepsiteratecurnextdiffUnexpected number\nUnexpected function\nerror: `` is not defined\n")
  (global $i32_stash (mut i32) (i32.const 0))
  (global $env_base i32 (i32.const 144))
  (global $env_top (mut i32) (i32.const 144))
...
(func $f1 (result i32)
i64.const 51539607553  ;; x
i64.const 21474836483  ;; $a0
call $get_value
call $set_value
i64.const 55834574851  ;; eps
f64.const 0.000100
global.set $value_f64
i32.const 0
call $set_value
i64.const 68719476743  ;; iterate
i32.const 2
...
(func $f2 (result i32)
i64.const 98784247811  ;; cur
i64.const 21474836483  ;; $a0
call $get_value
call $set_value
i64.const 111669149700  ;; next
i64.const 98784247811  ;; cur
call $get_value
call $typecheck_f64
i64.const 51539607553  ;; x
...
global.get $i32_stash
            ...
            (global.set
              ...
              (i32.load
                (i32.add
                  ...
                  (i32.const 20))))
            (return (i32.const 1))))))
    (call $write_str (i32.const 72) (i32.const 8)) ;; "error: `"
    (call $write_str
          (i32.wrap_i64 (i64.shr_u (local.get $text_id) (i64.const 32)))
          (i32.wrap_i64 (local.get $text_id)))
    (call $write_str (i32.const 80) (i32.const 17)) ;; "` is not defined"
  ...
  (func $typecheck_f64 (param $flag i32) (result f64)
    (if
      (local.get $flag)
      (then
        (call $write_str (i32.const 52) (i32.const 20)) ;; "Unexpected function"
        (call $exit (i32.const 1))
        (unreachable)))
  ...
  (func $typecheck_fun (param $flag i32) (result i32)
    (if
      ...
      (then
        (call $write_str (i32.const 34) (i32.const 18)) ;; "Unexpected number"
        (call $exit (i32.const 1))
        (unreachable)))
