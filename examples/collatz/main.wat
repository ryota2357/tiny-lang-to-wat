(module
  ...
  (data (i32.const 0) "print$a0divab$a1collatznUnexpected number\nUnexpected function\nerror: `` is not defined\n")
...
global.get $i32_stash
            ...
            (global.set
              ...
              (i32.load
                (i32.add
                  ...
                  (i32.const 20))))
            (return (i32.const 1))))))
    (call $write_str (i32.const 62) (i32.const 8)) ;; "error: `"
    (call $write_str
          (i32.wrap_i64 (i64.shr_u (local.get $text_id) (i64.const 32)))
          (i32.wrap_i64 (local.get $text_id)))
    (call $write_str (i32.const 70) (i32.const 17)) ;; "` is not defined"
  ...
  (func $typecheck_f64 (param $flag i32) (result f64)
    (if
      (local.get $flag)
      (then
        (call $write_str (i32.const 42) (i32.const 20)) ;; "Unexpected function"
        (call $exit (i32.const 1))
        (unreachable)))
  ...
  (func $typecheck_fun (param $flag i32) (result i32)
    (if
      ...
      (then
        (call $write_str (i32.const 24) (i32.const 18)) ;; "Unexpected number"
        (call $exit (i32.const 1))
        (unreachable)))
